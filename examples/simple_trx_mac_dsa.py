...
# Title: Simple Trx Mac Dsa
# Generated: Fri Jan  4 18:07:16 2019
##################################################
...
class simple_trx_mac_dsa(gr.top_block):

    def __init__(self, ampl=0.7, args='addr=192.168.10.3', arq_timeout=.1*0 + 0.04, broadcast_interval=1, dest_addr=85, lo_offset=5e6, max_arq_attempts=5 * 2, mtu=2000, port='12346', radio_addr=86, rate=1e6, rx_antenna='TX/RX', rx_freq=915e6, rx_gain=65-20, rx_lo_offset=0, samps_per_sym=4, tx_freq=915e6, tx_gain=45, tx_lo_offset=0):
        gr.top_block.__init__(self, "Simple Trx Mac Dsa")
        ...
        self.dsa_vt_simple_mac_dsa_0 = dsa_vt.simple_mac_dsa(
        self.sdr_source,
        radio_addr,
        0.04,
        10,
        ...
        # Connections
        ##################################################
        self.msg_connect((self.blocks_message_strobe_0, 'strobe'), (self.dsa_vt_simple_mac_dsa_0, 'ctrl_in'))
        self.msg_connect((self.blocks_socket_pdu_0, 'pdus'), (self.mac_virtual_channel_encoder_0, 'in'))
        self.msg_connect((self.dsa_vt_simple_mac_dsa_0, 'to_radio'), (self.gmsk_radio_0, 'msg_in'))
        self.msg_connect((self.dsa_vt_simple_mac_dsa_0, 'to_app'), (self.mac_virtual_channel_decoder_0, 'in'))
        self.msg_connect((self.gmsk_radio_0, 'msg_out'), (self.dsa_vt_simple_mac_dsa_0, 'from_radio'))
        self.msg_connect((self.mac_virtual_channel_decoder_0, 'out0'), (self.blocks_socket_pdu_0, 'pdus'))
        self.msg_connect((self.mac_virtual_channel_encoder_0, 'out'), (self.dsa_vt_simple_mac_dsa_0, 'from_app'))
...
def argument_parser():
    ...
    parser.add_option(
        "", "--mtu", dest="mtu", type="intx", default=2000,
...
def main(top_block_cls=simple_trx_mac_dsa, options=None):
    if options is None:

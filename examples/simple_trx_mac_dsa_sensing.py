...
# Title: Simple Trx Mac Dsa Sensing
# Generated: Fri Jan  4 16:10:50 2019
##################################################
...
class simple_trx_mac_dsa_sensing(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, ampl=0.7, args='addr=192.168.10.3', arq_timeout=.1*0 + 0.04, broadcast_interval=1, dest_addr=85, lo_offset=5e6, max_arq_attempts=5 * 2, mtu=255, port='12346', radio_addr=86, rate=1e6, rx_antenna='TX/RX', rx_freq=915e6, rx_gain=65-20, rx_lo_offset=0, samps_per_sym=4, tx_freq=915e6, tx_gain=45, tx_lo_offset=0):
        gr.top_block.__init__(self, "Simple Trx Mac Dsa Sensing")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Simple Trx Mac Dsa Sensing")
        ...
        self.settings = Qt.QSettings("GNU Radio", "simple_trx_mac_dsa_sensing")
        ...
        self.dsa_vt_sensing_engine_0 = dsa_vt.sensing_engine(
        self.sdr_source,
              -10,
              )
        ...
        self.connect((self.blocks_complex_to_mag_squared_0, 0), (self.dsa_vt_sensing_engine_0, 0))
...
def main(top_block_cls=simple_trx_mac_dsa_sensing, options=None):
    if options is None:
